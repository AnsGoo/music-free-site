...
hero:
  name: ""
  text: "让听歌这件事变得简单一点"
  tagline: 集媒体库管理、元数据刮削与插件化扩展于一体的拥有无限可能的音乐服务器。
  actions:
    - theme: brand
      text: 功能
      link: /feature
...
mfFeatures:
  - iconKey: library
    title: 完善的音乐管理功能
    details: 本地与 WebDAV 媒体源、扫描入库、去重、在线播放；可作为 OpenSubsonic 服务端被音流、Supersonic 等客户端接入。
    link: /music
    linkText: 音乐模块
  - iconKey: scraper
    title: 便捷的元数据刮削体验
    details: 单曲 / 专辑 / 艺术家信息补全，封面与歌词可分源匹配；支持多插件编排，按需组合刮削链路。
    link: /music
    linkText: 刮削说明
  - iconKey: plugin
    title: 无限可能的插件化扩展方案
    details: 远程搜索与下载、平台歌单导入、多数据源刮削；订阅注册表、安装 WASM 插件即可扩展能力，无需改核心。
    link: /plugin
    linkText: 插件体系

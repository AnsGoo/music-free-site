...
MusicFree 插件系统基于 [Extism WASI WASM](https://extism.org/) 实现。

相关文档：[插件介绍](/plugin) · [注册表协议](/plugin-registry) · [插件编排](/plugin-orchestration) · [第三方插件合集](/plugin-collection)

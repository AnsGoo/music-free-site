...
![folder-playlist.webp](https://ansgoo.github.io/music-free-site/img/folder-playlist.webp)
...
- 返回精确的 `Content-Length`，并支持 HTTP Range（206）分段请求；
- ffmpeg 写入完整的 Info/Xing 头，渲染器可以据此正确显示总时长并拖动进度；
